...
def entry_get():
    ...
    if var1>31 or var2>12 :
        datet = ttk.Label(wdw, text=f"TRY TO VERIFY DATE FORMAT").grid(column=0, row=4)
    else :
        var1t = var1
        var2t = var2
        var3t = var3
        if var1 == 31:
            ...
            var1t = var1t + 1
    datet = ttk.Label(wdw, text=f"Tomorow's date : {var1t:.0f}.{var2t:.0f}.{var3t:.0f}").grid(column=0, row=4)
    
    
    
    date = ttk.Label(wdw, text=f"Today's date is : {var1:.0f}.{var2:.0f}.{var3:.0f}").grid(column=0, row=0)
